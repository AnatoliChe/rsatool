...
if __name__ == '__main__':
    ...
    try:
        ...
        if options.n and options.p and options.d and options.q and options.e:
            print('Using (n, p, d, q, e) to initialise RSA instance\n')
            rsa = RSA(p=options.p, n=options.n, q=options.q, e=options.e, d=options.d)
        elif options.n and options.p:
